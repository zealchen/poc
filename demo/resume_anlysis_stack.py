...
class ResumeAnalysisStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        handler = _lambda.DockerImageFunction(
            self, "ResumeAnalysisLambda",
            code=_lambda.DockerImageCode.from_image_asset(
                directory="src_lambdas",
                file="resume_analysis/Dockerfile",
        ...
        http_api = apigwv2.HttpApi(self, "ResumeAnalysisHttpApi",
            api_name="ResumeAnalysisHttpApi",
        ...
        lambda_integration = integrations.HttpLambdaIntegration(
            "ResumeAnalysisRootIntegration", 
            handler=alias,
            timeout=Duration.seconds(29)
        )
        
        proxy_integration = integrations.HttpLambdaIntegration(
            "ResumeAnalysisProxyIntegration", 
            handler=alias,
            timeout=Duration.seconds(29)
        )
        ...
        CfnOutput(self, "ResumeAnalysisApiUrl", value=http_api.api_endpoint)
